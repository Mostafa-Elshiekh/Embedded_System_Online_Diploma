...
//DISABLE
//USART
#define NVIC_IRQ37_USART1_DISABLE()           (NVIC_ISER1 &=~(1<<5)) //37-32=5
#define NVIC_IRQ38_USART2_DISABLE()           (NVIC_ISER1 &=~(1<<6)) //38-32=6
#define NVIC_IRQ39_USART3_DISABLE()           (NVIC_ISER1 &=~(1<<7)) //39-32=7
